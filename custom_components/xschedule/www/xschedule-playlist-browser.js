 ...
 */class ot extends b{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,s)=>{const i=s?.renderBefore??e;let n=i._$litPart$;if(void 0===n){const t=s?.renderBefore??null;i._$litPart$=n=new Z(e.insertBefore(k(),t),t,void 0,s??{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return B}}ot._$litElement$=!0,ot.finalized=!0,nt.litElementHydrateSupport?.({LitElement:ot});const rt=nt.litElementPolyfillSupport;rt?.({LitElement:ot}),(nt.litElementVersions??=[]).push("4.2.1");class at extends ot{static get properties(){return{hass:{type:Object},config:{type:Object},_entity:{type:Object},_playlists:{type:Array},_playlistSchedules:{type:Object},_loading:{type:Boolean},_expandedPlaylist:{type:String},_playlistSongs:{type:Object}}}constructor(){super(),this._playlists=[],this._playlistSchedules={},this._loading=!1,this._expandedPlaylist=null,this._playlistSongs={},this._updateInterval=null,this._initialLoad=!0}connectedCallback(){super.connectedCallback(),this._updateInterval=setInterval(()=>{this.requestUpdate()},3e5),this._hass&&this._subscribeToCacheEvents()}disconnectedCallback(){super.disconnectedCallback(),this._updateInterval&&(clearInterval(this._updateInterval),this._updateInterval=null),this._unsubscribeCacheEvents()}setConfig(t){if(!t.entity)throw new Error("You need to define an entity");this.config={entity:t.entity,sort_by:t.sort_by||"schedule",show_duration:!1!==t.show_duration,show_status:!1!==t.show_status,compact_mode:t.compact_mode||!1,confirm_play:!1!==t.confirm_play,...t}}set hass(t){const e=this._hass;this._hass=t,!e&&t&&this._subscribeToCacheEvents();const s=this.config.entity;if(this._entity=t.states[s],this._entity){const t=this._entity.attributes.source_list||[];if(JSON.stringify(this._playlists)!==JSON.stringify(t)&&(this._playlists=t,t.length>0)){const t=this._initialLoad;this._initialLoad&&(this._initialLoad=!1),this._fetchScheduleInfo(t)}}}async _fetchScheduleInfo(t=!1){if(!this._loading){this._loading=!0;try{const e={};for(const s of this._playlists)try{const i=await this._hass.callWS({type:"call_service",domain:"xschedule",service:"get_playlist_schedules",service_data:{entity_id:this.config.entity,playlist:s,force_refresh:t},return_response:!0});if(i&&i.response&&i.response.schedules&&i.response.schedules.length>0){const n=i.response.schedules;let o=null;const r=n.find(t=>"TRUE"===t.active||"NOW!"===t.nextactive);if(r)o=r;else{const t=n.filter(t=>{const e=t.nextactive;return e&&"A long time from now"!==e&&"N/A"!==e&&e.match(/\d{4}-\d{2}-\d{2}/)}).sort((t,e)=>new Date(t.nextactive)-new Date(e.nextactive));o=t.length>0?t[0]:n[0]}if(!o)continue;const a=await this._hass.callWS({type:"call_service",domain:"xschedule",service:"get_playlist_steps",service_data:{entity_id:this.config.entity,playlist:s,force_refresh:t},return_response:!0});let l=0;a&&a.response&&a.response.steps&&(l=a.response.steps.reduce((t,e)=>t+(e.duration||0),0)),e[s]={nextActiveTime:o.nextactive,enabled:o.enabled,active:o.active,duration:l}}}catch(t){console.error(`Failed to fetch schedule for ${s}:`,t)}this._playlistSchedules=e}finally{this._loading=!1,this.requestUpdate()}}}_subscribeToCacheEvents(){this._hass&&!this._cacheEventUnsub&&(this._cacheEventUnsub=this._hass.connection.subscribeEvents(t=>{t.data.entity_id===this.config.entity&&(console.debug("Backend cache invalidated, refetching schedule info"),this._fetchScheduleInfo(!0))},"xschedule_cache_invalidated"))}_unsubscribeCacheEvents(){this._cacheEventUnsub&&(this._cacheEventUnsub.then(t=>t()),this._cacheEventUnsub=null)}render(){return this._entity?L`
    ...
    `:L`
      ...
      `}async _addSongToQueue(t,e,s){t.stopPropagation();try{await this._hass.callService("xschedule","add_to_queue",{entity_id:this.config.entity,playlist:e,song:s})}catch(t){console.error("Failed to add to queue:",t)}}getCardSize(){return this.config.compact_mode?4:6}static get styles(){return o`
      :host {
        display: block;
      }
